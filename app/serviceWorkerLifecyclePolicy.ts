...
// Registration is owned once by the application entry point through
// `virtual:pwa-register`. Injecting an additional registration script would
// create a second, uncoordinated service-worker lifecycle.

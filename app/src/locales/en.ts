export const en = {
    startPage: {
        ...
        login: {
            ...
            claudeBetaHint: "An alternative for adult users with a Claude account. Connect SkillPilot to Claude once, then start directly.",
            claudeAdultsOnly: "According to the provider, Claude.ai is only available to users aged 18 or older.",
            claudeConnect: "Connect Claude once",
            claudeConnecting: "Preparing connection…",
            claudeInstallOpened: "The Claude connection opened in a new tab.",
            claudeStart: "Start with Claude",
            claudeStarting: "Preparing Claude…",
            claudeLaunched: "Claude is open and the short start message was copied. Paste and send it. If needed, enable SkillPilot in the chat's connector menu.",
            claudeLaunchedCopyFailed: "Claude is open, but the start message could not be copied automatically. If needed, enable SkillPilot in the chat's connector menu.",
            claudeFallbackHint: "The new window was blocked. Open Claude using one of the links and paste the short start message there.",
            claudeClipboardFallbackHint: "Copy the short start message here and paste it into the Claude tab that is already open.",
            claudeCopyPrompt: "Copy start message",
            claudePromptCopied: "Start message copied.",
            claudeOpenWeb: "Open Claude in browser",
            claudeOpenApp: "Open Claude Desktop",
            claudeInstallFallback: "Open Claude connection",
            claudeDisconnect: "Disconnect Claude",
            claudeDisconnecting: "Disconnecting Claude…",
            claudeDisconnected: "The Claude connection and its OAuth access have been revoked.",
            claudeFailed: "Claude could not be prepared. Please try again or use ChatGPT.",
            ...
            startStepText: "Start the learning coach in ChatGPT or continue in the cockpit.",
            startStepTextWithClaude: "Choose ChatGPT or the Claude beta as your learning coach, or continue in the cockpit.",

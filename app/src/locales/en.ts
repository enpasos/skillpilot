export const en = {
    startPage: {
        ...
        login: {
            ...
            claudeLaunched: "Claude is open with the start message already filled in. Review and send it. If needed, enable SkillPilot in the chat's connector menu.",
            claudeLaunchedCopyFailed: "Claude is open with the start message already filled in. Review and send it. If needed, enable SkillPilot in the chat's connector menu.",

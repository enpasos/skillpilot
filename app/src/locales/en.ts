export const en = {
    startPage: {
        ...
        login: {
            ...
            startPromptLabel: "Start code for SkillPilot GPT",
            ...
            openChatGpt: "Start SkillPilot GPT",
            ...
            startStepText: "A temporary session is prepared internally. The cockpit opens directly; SkillPilot GPT starts with a short-lived start code.",
            curriculumLabel: {

export const en = {
    startPage: {
        ...
        login: {
            ...
            claudeBetaBadge: "v1",
            claudeBetaHint: "Set up the SkillPilot plugin and connector once. Then choose again at every start whether you want to learn with Claude.",
            claudeAdultsOnly: "According to the provider, Claude.ai is only available to users aged 18 or older.",
            claudeConnect: "Set up plugin and connector",
            claudeConnecting: "Opening setup…",
            claudeInstallOpened: "The Claude setup opened in a new tab.",
            ...
            claudeInstallFallback: "Open Claude setup",
            claudeDisconnect: "Reset Claude setup",
            claudeDisconnecting: "Resetting setup…",
            claudeDisconnected: "The local Claude setup confirmation was reset.",
            ...
            startStepTextWithClaude: "Choose ChatGPT or Claude as your learning coach for this start, or continue in the cockpit.",

export const en = {
    startPage: {
        ...
        login: {
            ...
            storedLoginTitle: "Use saved access",
            storedProfileLabel: "Saved access",
            directIdTitle: "Your SkillPilot ID",
            idFieldHint: "Enter an existing ID or fill the field using one of the options below.",
            passwordLabel: "Password",
            loadStoredLogin: "Use SkillPilot ID",
            loadingStoredLogin: "Loading...",
            deleteStoredLogin: "Delete access",
            localLoginLoaded: "SkillPilot ID loaded.",
            localLoginFailed: "Access could not be loaded.",
            idLabel: "Enter an existing SkillPilot ID",
            idSourceExisting: "Existing ID",
            idSourceGenerated: "Newly generated ID",
            idSourceStored: "Saved access",

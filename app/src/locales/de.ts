export const de = {
    ...
    tooltips: {
        ...
        legacyReadOnly: "In der Legacy-Ansicht schreibgeschuetzt",
    ...
    notifications: {
        ...
        compatibilityArchiveExported: "Kompatibilitaetsarchiv exportiert.",
        compatibilityArchiveExportFailed: "Kompatibilitaetsarchiv konnte nicht exportiert werden.",
        learnerImported: "Lernstand importiert.",
        learnerImportFailed: "Lernstand konnte nicht importiert werden.",
        learnerImportValidationFailed: "Import fehlgeschlagen: Die Exportdatei ist nicht unveraendert oder die Signatur ist ungueltig.",
        ...
        learnerInitialLoadFailed: "Ein Teil deines Lernstands konnte nicht geladen werden. Bitte aktualisiere die Seite spaeter erneut.",
        ...
        personalCurriculumSaveFailed: "Persoenliches Curriculum konnte nicht gespeichert werden.",
        preferencesSaveFailed: "Lernpraeferenzen konnten nicht gespeichert werden.",
        trainerClassSaveFailed: "Klassendaten konnten lokal nicht gespeichert werden.",
        trainerPlannedGoalSaveFailed: "Der Lernplan dieses Schuelers konnte nicht gespeichert werden.",
        trainerBulkPlannedGoalSaveFailed: "Die Lernzielzuweisung fuer die Klasse konnte nicht gespeichert werden.",
        trainerInitialLoadFailed: "Trainerdaten konnten nicht vollstaendig geladen werden. Bitte aktualisiere die Seite spaeter erneut.",
        trainerClassDataLoadFailed: "Die Lernstaende oder Lernplaene der Klasse konnten nicht vollstaendig geladen werden.",

export const de = {
    startPage: {
        ...
        login: {
            ...
            claudeBetaHint: "Alternative für volljährige Nutzer:innen mit einem Claude-Konto. Verbinde SkillPilot einmal mit Claude und starte danach direkt.",
            claudeAdultsOnly: "Claude.ai ist laut Anbieter erst ab 18 Jahren nutzbar.",
            claudeConnect: "Claude einmalig verbinden",
            claudeConnecting: "Verbindung wird vorbereitet …",
            claudeInstallOpened: "Die Claude-Verbindung wurde in einem neuen Tab geöffnet.",
            ...
            claudeInstallFallback: "Claude-Verbindung öffnen",
            claudeDisconnect: "Claude-Verbindung trennen",
            claudeDisconnecting: "Claude-Verbindung wird getrennt …",
            claudeDisconnected: "Die Claude-Verbindung und ihre OAuth-Zugriffe wurden getrennt.",

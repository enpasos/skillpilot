export const de = {
    startPage: {
        ...
        login: {
            ...
            openAiMcpHint: "SkillPilot öffnet den normalen ChatGPT-Chat und zeigt eine kurze Startnachricht an. Aktiviere dort die App „SkillPilot Coach (Deutsch)“, kopiere die Nachricht und schicke sie ab.",
            openAiMcpStart: "SkillPilot-App öffnen",
            openAiMcpConnectedHint: "Die Verbindung ist aktiv. Die Startnachricht wurde nach Möglichkeit kopiert; füge sie im geöffneten ChatGPT-Chat ein.",
            ...
            openAiMcpCopyPrompt: "Startnachricht kopieren",
            openAiMcpCopyFailed: "Die Startnachricht konnte nicht automatisch kopiert werden. Markiere sie oben und kopiere sie manuell.",
            openAiMcpPopupBlocked: "ChatGPT konnte nicht automatisch geöffnet werden. Öffne ChatGPT in einem neuen Tab und kopiere die Startnachricht von hier.",

export const de = {
    startPage: {
        ...
        login: {
            ...
            loginText: "Erstelle eine SkillPilot-ID oder verwende deinen gespeicherten Zugang.",
            ...
            loadStoredLogin: "Zugang öffnen",
            loadingStoredLogin: "Lade...",
            deleteStoredLogin: "Zugang löschen",
            saveLocalLoginTitle: "Aktuellen Zugang auf diesem Gerät speichern",

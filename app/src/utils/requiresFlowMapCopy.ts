...
export const getRequiresFlowMapCopy = (language: LabelLanguage): RequiresFlowMapCopy => (
  language === 'en'
    ...
    : {
        title: 'Requires-Flow',
        subtitle: 'Direkte/vererbte Voraussetzungen und naechste freischaltbare Ziele.',
        direct: 'direkt',
        inherited: 'vererbt',
        ...
        nextStepsColumnTitle: 'Naechste Schritte',
        ...
        fullFlowSummaryDone: 'alle Vorbedingungen erfuellt',

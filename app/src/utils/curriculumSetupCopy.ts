...
export const getPersonalCurriculumSetupCopy = (
  ...
  ...(language === 'de'
    ? {
        ...
        autoPilotDescription: 'Wählt nach deinem bestätigten Abschluss das nächste passende Lernziel. Du entscheidest, wann es weitergeht.',
    ...
    : {
        ...
        autoPilotDescription: 'Selects the next suitable goal after you confirm completion. You decide when to continue.',

...
export const getPersonalCurriculumSetupCopy = (
  ...
  ...(language === 'de'
    ? {
        ...
        autoPilotDescription: 'Startet automatisch das naechste Ziel nach Abschluss.',
        strictModeTitle: 'Strict Mode aktivieren',
        strictModeDescription: 'Prueft alle Voraussetzungen global, auch ausserhalb deines aktuellen Fokus.',
        ...
        compatibility: {
          ...
          suffix: 'Kompatibilitaetsansicht',
        },
      }
    : {
        title: 'My Curriculum',

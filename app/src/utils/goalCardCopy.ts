...
export const getGoalCardCopy = (language: LabelLanguage): GoalCardCopy => (
  language === 'en'
    ...
    : {
        examTaskLabel: 'Pruefungsaufgabe',
        solutionLabel: 'Musterloesung',
        projectedStructureBadge: 'Struktur',
        projectedStructureTitle: 'Projizierter Strukturknoten',
        projectedStructureDescription: 'Dieser Knoten wird zur Laufzeit aus programUnits und goalPlacements projiziert. Er gruppiert Inhalte fuer Navigation und Fortschritt, ist aber kein eigenstaendiges fachliches Lernziel.',
        ...
        activeActionSelect: 'Als aktuelles Lernziel auswaehlen',
        ...
        licenseLabel: 'Lizenz: ',
        appliesToLabel: 'Gilt fuer:',
        helpfulResourcesLabel: 'Hilfreiche Quellen:',
        tagsLabel: 'Tags:',
        leitideenLabel: 'Leitideen:',
        kompetenzenLabel: 'Kompetenzen:',
        examplesLabel: 'Beispiele:',
        legacyReadOnlyNotice: 'Diese Legacy-Ansicht ist schreibgeschuetzt. Fuer aktives Lernen und Statusaenderungen bitte auf Gymnasium (DE) umstellen.',
        nextStepsLabel: 'Naechste Schritte',
        selectAsActiveGoalLabel: 'Als aktuelles Ziel auswaehlen',
        ...
        progressForGoalLabel: 'Kompetenzstand fuer dieses Lernziel',
        projectedProgramUnitKinds: {
          stage: 'Stufe',
          year: 'Jahrgang',
          phase: 'Phase',

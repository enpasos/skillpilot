...
const germanVariants: CoachMatrixVariant[] = [
  ...
  },
  {
    ...
    provider: 'Claude',
    plan: 'Pro',
    badge: 'Claude-1.1-Betakandidat',
    summary: 'Der von SkillPilot unterstützte Kandidatenweg: Plugin in Claude Web hochladen. Die exakte 1.1-Abnahme in Web, Android und Voice Mode steht noch aus.',
  },
  {
...
const englishVariants: CoachMatrixVariant[] = [
  ...
  },
  {
    ...
    provider: 'Claude',
    plan: 'Pro',
    badge: 'Claude 1.1 beta candidate',
    summary: 'The candidate route supported by SkillPilot: upload the plugin in Claude Web. Exact 1.1 acceptance in Web, Android, and voice mode is still pending.',
  },
  {
    id: 'claude-team-enterprise',
    provider: 'Claude',
    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Bedingt als geführter SkillPilot-1.1-Betakandidat', 'Lade die aktuelle Plugin-Datei einmalig in Claude Web hoch. Die exakte 1.1-Client-Abnahme steht noch aus.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Claude Pro', 'Plugins funktionieren technisch auch mit anderen bezahlten Claude-Tarifen; SkillPilot unterstützt für den 1.1-Betakandidaten derzeit Pro. Die exakte Client-Abnahme steht noch aus.'),
    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'In SkillPilot „Lernen starten“ wählen', 'Die Installation des 1.1-Betakandidaten erfolgt vorher einmalig in Claude Web; die exakte Client-Abnahme steht noch aus.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Vorgesehen: 24 Stunden ab dem Start', 'Danach in SkillPilot eine neue Lernsession starten. Die exakte 1.1-Client-Abnahme steht noch aus.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Dauerhafter Lernstand bleibt bei SkillPilot', 'Teile die vorbereitete Startnachricht und den Lernchat nicht mit anderen. Die exakte 1.1-Client-Abnahme steht noch aus.'),
    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Vorgesehen: aktuelles Lernziel, Tagesplan, Fortschritt, Kartenübungen und Abfragen', 'Freigegebene Lernzielbilder sind enthalten. Die exakte 1.1-Abnahme dieser Funktionen in Web, Android und Voice Mode steht noch aus.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-free': cell('unavailable', 'Kein vollständiger Plugin-Zugang'),
          'claude-pro-max': cell('conditional', 'Claude Web; Android mit demselben Konto vorgesehen', 'Die exakte 1.1-Abnahme in beiden Clients steht noch aus.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-free': cell('unavailable', 'Kein vollständiger Plugin-Zugang'),
          'claude-pro-max': cell('conditional', 'Für 1.1 vorgesehen: Android nach der Installation in Claude Web', 'Die exakte Android-Abnahme steht noch aus; keine Installation direkt in der Android-App.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-free': cell('unavailable', 'Kein vollständiger Plugin-Zugang'),
          'claude-pro-max': cell('conditional', 'Für 1.1 vorgesehen; Android-Voice-Abnahme ausstehend', 'Die exakte Client-Abnahme steht noch aus; die Anzeige einzelner UI-Elemente wird nicht garantiert.'),
          'claude-team-enterprise': cell('admin', 'Nicht Teil des aktuellen SkillPilot-Betawegs'),
        },
      },
    ],
    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Conditional as a guided SkillPilot 1.1 beta candidate', 'Upload the current plugin file once in Claude Web. Exact 1.1 client acceptance is still pending.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Claude Pro', 'Plugins technically work with other paid Claude plans too; SkillPilot currently supports Pro for the 1.1 beta candidate. Exact client acceptance is still pending.'),
    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Select “Start Learning” in SkillPilot', 'Install the 1.1 beta candidate once in Claude Web beforehand; exact client acceptance is still pending.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Intended: 24 hours from the start', 'After that, start a new learning session in SkillPilot. Exact 1.1 client acceptance is still pending.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Your long-term learning record stays with SkillPilot', 'Do not share the prepared start message or your learning chat. Exact 1.1 client acceptance is still pending.'),
    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('conditional', 'Intended: current learning goal, daily plan, progress, card practice, and assessments', 'Approved goal images are included. Exact 1.1 acceptance of these functions in Web, Android, and voice mode is still pending.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-free': cell('unavailable', 'No complete plugin access'),
          'claude-pro-max': cell('conditional', 'Claude Web; Android intended with the same account', 'Exact 1.1 acceptance in both clients is still pending.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-free': cell('unavailable', 'No complete plugin access'),
          'claude-pro-max': cell('conditional', 'Intended for 1.1: Android after installing in Claude Web', 'Exact Android acceptance is still pending; no installation from inside the Android app.'),
      ...
      },
      {
        ...
        cells: {
          ...
          'claude-free': cell('unavailable', 'No complete plugin access'),
          'claude-pro-max': cell('conditional', 'Intended for 1.1; Android voice acceptance pending', 'Exact client acceptance is still pending; display of every UI element is not guaranteed.'),
          'claude-team-enterprise': cell('admin', 'Not part of the current SkillPilot beta route'),
        },
      },
    ],
...
const germanCopy: CoachProviderMatrixCopy = {
  ...
  intro: 'Diese Übersicht brauchst du nur bei der ersten Einrichtung oder wenn du dein ChatGPT- oder Claude-Konto wechselst. Für Claude unterstützt SkillPilot derzeit einen klar begrenzten 1.1-Betakandidaten mit Claude Pro und einer manuell hochgeladenen Plugin-Datei; die exakte Client-Abnahme steht noch aus.',
  asOf: 'Stand: 4. September 2026',
  ...
  startTitle: 'So ist der Alltagseinstieg vorgesehen',
  startText: 'Für den Claude-1.1-Betakandidaten wählst du in SkillPilot „Lernen starten“. Dadurch entsteht eine neue Lernsession, die 24 Stunden gültig ist. Die exakte Client-Abnahme dieses Ablaufs steht noch aus.',
  ...
  caveat: 'Anbieter können Tarife und verfügbare Funktionen ändern. Entscheidend ist deshalb immer, was dein eigenes Konto anzeigt. Installiere den Claude-1.1-Betakandidaten nur über den SkillPilot-Plugin-Download. Frühere Tests anderer Paketversionen gelten nicht für 1.1; die exakte Abnahme in Claude Web, Android und Voice Mode steht noch aus.',
...
const englishCopy: CoachProviderMatrixCopy = {
  ...
  intro: 'You only need this overview during your first setup or when you change your ChatGPT or Claude account. For Claude, SkillPilot currently supports one clearly bounded 1.1 beta candidate with Claude Pro and a manually uploaded plugin file; exact client acceptance is still pending.',
  asOf: 'Status: September 4, 2026',
  ...
  legendLabel: 'Meaning',
  startTitle: 'The intended everyday start',
  startText: 'For the Claude 1.1 beta candidate, select “Start Learning” in SkillPilot. This creates a new learning session that is valid for 24 hours. Exact client acceptance of this flow is still pending.',
  ...
  caveat: 'Providers may change plans and available features. What your own account displays is therefore authoritative. Install the Claude 1.1 beta candidate only through the SkillPilot plugin download. Tests of earlier package versions do not apply to 1.1; exact acceptance in Claude Web, Android, and voice mode is still pending.',

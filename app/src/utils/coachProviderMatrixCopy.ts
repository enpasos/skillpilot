    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('tested', 'Ja, im eingeladenen SkillPilot-Beta-Test', 'Wenn SkillPilot dir den Downloadlink bereitgestellt hat, lädst du das Plugin zunächst in Claude Web hoch.'),
    ...
    rows: [
      {
        ...
        cells: {
          ...
          'claude-pro-max': cell('tested', 'Yes, in the invited SkillPilot beta test', 'If SkillPilot has provided you with the download link, upload the plugin in Claude Web first.'),
...
const germanCopy: CoachProviderMatrixCopy = {
  ...
  sources: [
    ...
    { id: 'anthropic-interactive-connectors', label: 'Claude: interaktive Connectoren auf Mobilgeräten', href: 'https://support.claude.com/en/articles/13454812-use-interactive-connectors-in-claude' },
...
const englishCopy: CoachProviderMatrixCopy = {
  ...
  sources: [
    ...
    { id: 'anthropic-voice', label: 'Claude: voice mode', href: 'https://support.claude.com/en/articles/11101966-use-voice-mode' },
    { id: 'anthropic-interactive-connectors', label: 'Claude: interactive connectors on mobile', href: 'https://support.claude.com/en/articles/13454812-use-interactive-connectors-in-claude' },

...
export const getFlashcardDrillCopy = (language: LabelLanguage): FlashcardDrillCopy => (
    language === 'en'
        ...
        : {
            ...
            noCardsForFilter: 'Keine Karteikarten fuer den aktuellen Filter gefunden.',
            new: 'Neu',
            learn: 'Lernen',
            review: 'Wdh.',
            master: 'Meister',
            noneDue: 'Derzeit keine Karten zur Wiederholung faellig.',
            back: 'Zurueck zum Lehrplan',
            ...
            readyForReview: 'Bereit fuer heute: {0}.',

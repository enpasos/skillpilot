...
const overviewActionRestingClassName =
  'border-border-color bg-input-bg text-text-secondary hover:border-emerald-300/80 hover:bg-emerald-50/70 hover:text-emerald-900 dark:hover:border-emerald-600/70 dark:hover:bg-emerald-950/25 dark:hover:text-emerald-200'

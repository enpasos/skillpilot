...
export const MarkdownDocumentVideoCard = forwardRef<MarkdownDocumentVideoCardHandle, MarkdownDocumentVideoCardProps>(({
  url,
  eyebrow,
  title,
  description,
  ...
  return (
    <section
      ...
      className="mb-10 scroll-mt-6 overflow-hidden rounded-3xl border border-sky-400/30 bg-gradient-to-br from-sky-950 via-slate-900 to-indigo-950 p-1 shadow-2xl shadow-sky-950/30"
    >
      <div className="rounded-[1.35rem] bg-slate-950/55 p-5 sm:p-7">
        <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex shrink-0 items-center gap-2 self-start rounded-full border border-sky-300/40 bg-sky-400/10 px-4 py-2 text-sm font-semibold text-sky-200 transition hover:border-sky-200/70 hover:bg-sky-300/20 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-200 sm:self-auto"
          >
...
MarkdownDocumentVideoCard.displayName = 'MarkdownDocumentVideoCard'

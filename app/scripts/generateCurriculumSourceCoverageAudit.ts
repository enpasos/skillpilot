...
function pushGeneratedMarkdownNotice(lines: string[]): void {
  ...
  lines.push('>')
  lines.push('> Generated by: `app/scripts/generateCurriculumSourceCoverageAudit.ts`')
  lines.push('> Regenerate with: `cd app && npm run quality:source-coverage-audit`')
  lines.push('> Source of truth: `app/scripts/generateCurriculumSourceCoverageAudit.ts`')
  lines.push('> Source of truth: `curricula/DE/Gymnasium/canonical/`')
  lines.push('> Source of truth: `curricula/DE/Gymnasium/provenance/canonical-goal-surrogate-evidence-registry.json`')
  lines.push('')
}

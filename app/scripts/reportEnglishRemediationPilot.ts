...
function pushGeneratedMarkdownNotice(lines: string[], statusPath: string): void {
  ...
  lines.push('>')
  lines.push('> Generated by: `app/scripts/reportEnglishRemediationPilot.ts`')
  lines.push('> Regenerate with: `cd app && npm run quality:english-remediation-pilot`')
  lines.push('> Source of truth: `app/scripts/reportEnglishRemediationPilot.ts`')

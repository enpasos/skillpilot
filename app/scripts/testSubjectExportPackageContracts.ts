...
import { sanitizeJsonForPackage } from './buildSkillpilotExportPackage'
import { unresolvedCompositionGoalReferences } from './validateSubjectExportPackages'
...
process.stdout.write(`Subject export contracts passed: sanitation, unresolved-reference negatives, current Mathematics, ${checkedViews} Physics views.\n`)

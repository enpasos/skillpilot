...
const sourceDocuments: SourceDocument[] = [
  ...
  ...[
    ['SL-LATEIN-G8-1FS-5-6', 'Latein_1.FS_5u6.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_1.FS_5u6.pdf?__blob=publicationFile&v=3'],
    ['SL-LATEIN-G8-1FS-7', 'Latein_1.FS_7_Gym_2003.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_1.FS_7_Gym_2003.pdf?__blob=publicationFile&v=4'],
    ['SL-LATEIN-G8-1FS-8', 'Latein_1.FS_8_Gym_2004.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_1.FS_8_Gym_2004.pdf?__blob=publicationFile&v=3'],
    ['SL-LATEIN-G8-1FS-9-10', 'Latein_1.FS_9u10_Gym_2005.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_1.FS_9u10_Gym_2005.pdf?__blob=publicationFile&v=4'],
    ['SL-LATEIN-G8-2FS-6-7', 'Latein_2.FS_6u7.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_2.FS_6u7.pdf?__blob=publicationFile&v=2'],
    ['SL-LATEIN-G8-2FS-8', 'Latein_2.FS_8_Gym_2004.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_2.FS_8_Gym_2004.pdf?__blob=publicationFile&v=2'],
    ['SL-LATEIN-G8-2FS-9-10', 'Latein_2.FS_9u10_Gym_2005.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_2.FS_9u10_Gym_2005.pdf?__blob=publicationFile&v=4'],
    ['SL-LATEIN-G8-3FS-8-9', 'Latein_3.FS_8u9_Gym_2004.pdf', 'https://www.saarland.de/SharedDocs/Downloads/DE/mbk/Lehrpl%C3%A4ne/Lehrplaene_Gymnasium/Latein/Latein_3.FS_8u9_Gym_2004.pdf?__blob=publicationFile&v=4'],
  ].map(([key, fileName, url]) => ({
    key,

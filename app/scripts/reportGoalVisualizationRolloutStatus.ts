...
const subjectDefaults: Record<string, SubjectDefaults> = {
  ...
  physik: {
    ...
    currentResumeFilePath: 'tmp/goal-visualization-physik-batch-061.resume.txt',
    currentPromptAppendDirPath: 'tmp/goal-visualization-prompt-appends/physik-batch-061',

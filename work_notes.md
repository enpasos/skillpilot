...
- `ai/openai custom gpt/knowledge_docs/exam_proctor_v1.md`
- `ai/openai custom gpt/system_instructions_v1.md` (Trigger: `examData` -> Prüfungsmodus)
...
- In `exam_proctor_v1.md` steht: Task **verbatim**, **Header + Einreichungs‑Hinweis erlaubt** (keine Hinweise, kein Chunking).
...
2) **Doku-Drift**
   - `node-types.md`: "Task + Punkte" vs. `exam_proctor_v1.md`: "nur TaskContent".
...
**Konkret fuer `exam_proctor_v1.md`:**
...
1) **Regeln schaerfen** (exam_proctor_v1.md + node-types.md) fuer "verbatim task only" + "single submission".
...
- **Prüfungsmodus-Regeln angepasst**: `ai/openai custom gpt/knowledge_docs/exam_proctor_v1.md`
...
- **System-Instruction ergänzt**: `ai/openai custom gpt/system_instructions_v1.md`

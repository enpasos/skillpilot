...
- `ai/openai custom gpt/knowledge_docs/exam_proctor_v19.md`
...
- In `exam_proctor_v19.md` steht: Direktstart, nur TaskContent.
...
2) **Doku-Drift**
   - `node-types.md`: "Task + Punkte" vs. `exam_proctor_v19.md`: "TaskContent pur".
...
**Konkret fuer `exam_proctor_v19.md`:**
...
1) **Regeln schaerfen** (exam_proctor_v19.md + node-types.md) fuer "verbatim task only" + "single submission".
...
- **Prüfungsmodus-Regeln angepasst**: `ai/openai custom gpt/knowledge_docs/exam_proctor_v19.md`

...
- `ai/openai custom gpt/knowledge_docs/exam_proctor_v16.md`
...
- In `exam_proctor_v16.md` steht: Task **verbatim**, **Header + Einreichungs‑Hinweis erlaubt** (keine Hinweise, kein Chunking).
...
2) **Doku-Drift**
   - `node-types.md`: "Task + Punkte" vs. `exam_proctor_v16.md`: "nur TaskContent".
...
**Konkret fuer `exam_proctor_v16.md`:**
...
1) **Regeln schaerfen** (exam_proctor_v16.md + node-types.md) fuer "verbatim task only" + "single submission".
...
- **Prüfungsmodus-Regeln angepasst**: `ai/openai custom gpt/knowledge_docs/exam_proctor_v16.md`

...
SkillPilot positioniert sich als **Open-Source-Lernplattform** mit **KI-Unterstützung**, die Curricula als **Abhängigkeits-/Kompetenzgraph** modelliert, um **personalisierte Lernpfade** und **Mastery-Tracking** zu ermöglichen; explizit eingeladen wird die Community, über ein **"Curriculum Champions"-Programm** Curricula praktisch nutzbar und aktuell zu halten (Issues/PRs).

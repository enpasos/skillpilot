...
const canonicalPath = path.join(repoRoot, 'curricula/DE/Gymnasium/canonical/DE_DEU_S_GYM_CANONICAL_PHYSIK.de.json');
const qaPath = path.join(repoRoot, 'curricula/DE/Gymnasium/quality/goal-visualization-qa/physik.qa.json');
const sourceDir = path.join(repoRoot, 'curricula/DE/Gymnasium/visualizations/physik', id);

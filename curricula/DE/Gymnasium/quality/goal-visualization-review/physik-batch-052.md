...
| --- | --- | --- | --- |
| `ea2d5085-4ec1-5e33-87e0-15edcad635bf` | Spektrallinien deuten | `accepted_pilot` | The accepted image shows downward transitions between energy levels and a discrete line spectrum. The larger energy gap maps to the higher-frequency blue-violet line, the smaller gap to the lower-frequency red line, and the formula `Delta E = h*f` is consistent. |

...
<text x="771" y="778" class="small">x</text><text x="138" y="246" class="small">f(x)</text>
...
const svgPath=path.join(output,'f493-native-fallback-v2.svg'),pngPath=path.join(output,'f493-native-fallback-v2.png')

...
const prefix = 'curricula/DE/Gymnasium/quality/goal-description-review/mathematik/rollout-v1/2026-09-07/batch-040r-final-series-and-integrals-17-v1'
const helperPath = 'curricula/DE/Gymnasium/quality/goal-description-review/mathematik/rollout-v1/2026-09-07/batch-040r-final-series-and-integrals-17-v1/emit-current-carryover-v1.ts'
const expectedGoalIds = ["630bb145-9a3f-5c88-ab5a-fb69a9bb76e4","74b5a01b-c086-51d0-bc66-046029c92ef7","4d55ba50-8d67-560c-a10f-cccff4728c40","565fcd3f-52cd-5402-a0ac-a1069ed9c598","c66cb27b-8199-58fb-95f4-6314c0c2d07b","911f3200-1dbc-59a6-90df-c883c77de39c","1b664036-3c29-5d94-9f42-97069aaa2c53","df5eeadd-414e-50ae-84ec-7e5dbf7449d6","94d63ad9-ae1c-5ff2-b05e-188a0f5ebec6","ece68088-71a8-466b-874c-09e6baac19fc","90662398-a0fd-45bf-9ce9-2abbc20428ed","24f21c0c-b506-56ec-ad17-39b209af4585","5042fd2b-bab2-50be-8144-c9ccf5618615","269675a9-13cd-4a3a-ab75-63794f5c9710","9441bb35-2a2f-4edc-9d8a-bc58c257054d","a9ed219d-d497-55e5-a4e0-4d45d2554f6b"]
const explicitHolds: Record<string, string> = {
  "3862890e-9ea9-4c62-bcf2-e354c9d8f306": "Current A KEEP / B BLOCK: correct sum values do not refute six instead of eight drawn strips, duplicated zero marks and inconsistent f(t)=t+1 graph. HOLD the unchanged bound raster sha256:f8e2a6af14f8a5f930174fdbeb05af3af0a38728bfee0a4c41a72cf8d53609a8. Correct bilingual goal text needs no replacement. New image binding and current review required; no later C2 draft is approved."
}
// Read-only patch emitter for the explicitly selected current B040r KEEP/KEEP pairs after full A/B record-body synthesis.
...
async function main() {
  ...
  assert.equal(config.goalIds.length, 17)
  ...
  assert.equal(historicalDenominator, 797)
  ...
  const currentStateAudit = config.goalIds.map((id: string) => {
    ...
    const mixedKeepRevise = false // This B040r scope admits only KEEP/KEEP pairs, never the KEEP/BLOCK hold.
  ...
  assert.equal(index.groups[0].campaignGoalCount, 17)

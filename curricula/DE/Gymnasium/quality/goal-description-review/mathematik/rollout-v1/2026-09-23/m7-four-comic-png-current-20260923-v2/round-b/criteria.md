...
(`sha256:35cbc14e52971ea917d90204424beb7b6cbd55e036da511dd4e75f96a2be8ee1`).
...
representation is sufficient, as in the canonical description. For
`740ab443…`, the current P-v2 record was narrowed after a scope audit:
forming and distinguishing the two statements is required, but proving or
refuting the converse by counterexample belongs to a sibling goal. Review the

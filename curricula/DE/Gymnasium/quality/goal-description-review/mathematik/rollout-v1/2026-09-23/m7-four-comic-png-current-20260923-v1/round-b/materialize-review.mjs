...
if (
  campaign.bundleFingerprint !== 'sha256:92ad5daa7dc700cf1fa355ab2fe1a9205d671215412708edea759fbc1f68f2c7' ||
  ...
  sha(readFileSync(join(repoRoot, 'curricula/DE/Gymnasium/quality/goal-evidence/m7-four-comic-png-current-20260923-v1.review.jsonl'))) !== 'sha256:5672d454f4c3ebfc98b0a1b06c2e2769f2efa302ec0868f0b1fe166f46b65ac1'
) {
...
const decisions = [
  ...
  },
  {
    ...
    understandingEvidence: {
      ...
      observablePerformanceDe: 'Die lernende Person formuliert zu einem neuen mathematischen Wenn-dann-Satz beide abgeleiteten Aussagen mit korrekten Negationen, grenzt ihre Gültigkeit voneinander ab und widerlegt eine ungültige Umkehrung nötigenfalls mit einem Gegenbeispiel.',
      observablePerformanceEn: 'For a new mathematical if-then statement, the learner formulates both derived statements with correct negations, distinguishes their validity, and, where the converse is false, refutes it with a counterexample.',
    ...
    rationale: 'REVISE: Die derzeitige Beschreibung verlangt zwar, Umkehrung und Kontraposition von der Ausgangsaussage zu unterscheiden, nennt aber die entscheidende unterschiedliche Geltungsbeziehung nicht. Gerade die stets bestehende Äquivalenz nur der Kontraposition ist Kompetenzkern im Kapitel „Implikation und Äquivalenz unterscheiden“, nicht ein bloßes P-v2-Scoringdetail. Der Ersatz macht diese mathematische Grenze sichtbar, fordert aber weder einen Beweis durch Kontraposition noch eine neue Beweismethode des Nachfolgeziels. Die gerenderte Seite und das PNG zeigen nur die drei formal korrekten Pfeilrichtungen; sie belegen keine selbstständige Satzbildung. Das P-v2-Profil enthält unabhängige sprachlich-mathematische Fälle, ist jedoch nur KI-Kandidat. Für diesen Knoten ist kein direkter sourceRef geliefert; es wird keine externe Quellenabdeckung behauptet.',
    evidenceProfileRecommendation: 'none'
  }
];
...
const run = {
  ...
  startedAt: '2026-09-23T17:50:16.000Z',

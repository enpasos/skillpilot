...
const prefix = 'curricula/DE/Gymnasium/quality/goal-description-review/physik/rollout-v1/2026-09-07/batch-040r-final-wording-and-images-6-v1'
const helperPath = 'curricula/DE/Gymnasium/quality/goal-description-review/physik/rollout-v1/2026-09-07/batch-040r-final-wording-and-images-6-v1/emit-current-carryover-v1.ts'
const expectedGoalIds = ["594f7f21-6b8a-531c-8424-5f1dcbaf0f23","60211ac1-cbe1-5182-87ef-673a068c5b0a","89cadf81-143b-5f6b-82bd-29ba20d92a1b","206fe51d-cc78-5422-b139-32cc97eb1c37","aa0fa5fb-7bfb-5f9f-a606-3f7187cfb745","14d99a65-8d58-5647-88ab-02137b96d55b"]
...
async function main() {
  ...
  assert.equal(config.goalIds.length, 6)
  ...
  assert.equal(index.groups[0].campaignGoalCount, 6)

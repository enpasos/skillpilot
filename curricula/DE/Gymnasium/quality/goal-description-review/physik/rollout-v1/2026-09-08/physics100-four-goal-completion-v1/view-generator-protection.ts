...
const ids=new Set([
 ...
 '7f0798cb-5966-5dcb-beb3-84f637ab6139','7badac4d-2874-5b3a-87e8-bf8f4440b2a6','70b358bf-da6d-53ba-8393-51d5c2365b04','ca13e9cd-6377-540e-88c8-0308cddc8a7e',
])
...
export function preservePhysicsB034ViewPlacements(root:string,path:string,draft:Record<string,unknown>){
 return preserveB034PlacementsFromCurrent(draft,JSON.parse(readFileSync(resolve(root,path),'utf8')))
}

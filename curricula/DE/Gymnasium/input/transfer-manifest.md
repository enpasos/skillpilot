...
| `DE-HE` upper-secondary abi | `curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/` | `curricula/DE/Gymnasium/input/DE-HE/abi/` | exam/release assets by subject | `410M` | `2130` files | `2130` files | mirrored | keep frozen and referenceable |

...
| Finding-ID | Checklistenpunkte | Ergebnis (`behoben` / `teilweise` / `offen`) | Nachweis |
|---|---|---|---|
| F-001 | Metadaten/Formalia: LaTeX-Formeln; Display-Math-Leerzeilen | behoben | `Physik_Hessen_2026_Klausurbeispiel_1.md`, `Physik_Hessen_2026_Klausurbeispiel_1_Musterloesung.md`, `Schritt7_Finding_Bearbeitung.md` |
| F-002 | Metadaten/Formalia: Umlaute im Fließtext | behoben | `Physik_Hessen_2026_Klausurbeispiel_1.md`, `Physik_Hessen_2026_Klausurbeispiel_1_Musterloesung.md`, `Schritt7_Finding_Bearbeitung.md` |
| F-003 | Inhaltsabdeckung/Niveausteuerung GK-LK | behoben | `Physik_Hessen_2026_Klausurbeispiel_1.md`, `Physik_Hessen_2026_Klausurbeispiel_1_Musterloesung.md`, `abi_2026_physik_exam_blueprint.json`, `Schritt7_Finding_Bearbeitung.md` |
| F-004 | Präzision Modellannahmen (Induktion, GK A) | behoben | `Physik_Hessen_2026_Klausurbeispiel_1.md`, `Physik_Hessen_2026_Klausurbeispiel_1_Musterloesung.md` |
| F-005 | Operatorik/Didaktikbegriff „Tilger“ (LK B) | behoben | `Physik_Hessen_2026_Klausurbeispiel_1.md` |
| F-006 | Formale Rechtssicherheit Hilfsmittelwortlaut | behoben | `Physik_Hessen_2026_Klausurbeispiel_1.md` |

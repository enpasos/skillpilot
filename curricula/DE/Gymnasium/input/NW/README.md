...
- Archived source PDF: `lower-secondary/g9_m_klp_3401_2019_06_23_0.pdf`
- Source references: `lower-secondary/references.md`
- Pilot source snapshot: `lower-secondary/source-json/DE_NRW_S_GYM_1_MATHEMATIK.de.json.snapshot`

### Sekundarstufe II (Gymnasiale Oberstufe)
- **Kernlehrplan Mathematik gymnasiale Oberstufe (2023/2024)**: [Schulentwicklung NRW (QUA-LiS) - Lehrplannavigator Sek II](https://www.schulentwicklung.nrw.de/lehrplaene/lehrplannavigator-s-ii/gymnasiale-oberstufe/mathematik/mathematik-klp/index.html)
- Archived source PDF: `upper-secondary/gost_klp_m_2023_06_07.pdf`
- Source references: `upper-secondary/references.md`
- Pilot source snapshot: `upper-secondary/source-json/DE_NRW_S_GYM_2_MATHEMATIK.de.json.snapshot`

## Physik
### Sekundarstufe I (Klassen 5-10)
- **Kernlehrplan Physik Sekundarstufe I Gymnasium (2019)**: [Schulentwicklung NRW (QUA-LiS) - Lehrplannavigator Sek I](https://www.schulentwicklung.nrw.de/lehrplaene/lehrplannavigator-s-i/gymnasium-g9/physik-g9/)

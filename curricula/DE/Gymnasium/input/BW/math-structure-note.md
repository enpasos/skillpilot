...
- the imported Sek-I slice currently covers:
  ...
  - the broadened late-Sek-I `3.3.4` follow-on around trigonometrische Funktionen, periodische Modellierung, Ableitungsbegriff, grundlegenden Ableitungsregeln, Monotonie-/Extremwertuntersuchungen, Tangenten-, Normalen-, und Wendepunktdeutung sowie einfachen Sinus-/Kosinusableitungen in `Klassen 9/10`
...
- the next BW Sek-I widening step now also opens the broadened late-Sek-I `3.3.4` function / differential strip in `Klassen 9/10` on a dedicated canonical J10 differential corridor:
  ...
  - `47e1e733-de23-4120-bcab-cabc1427ff79 -> 7156558c-57f1-4372-9ba7-0640c3f7cb3a` for the derivative concept developed from secants and average rates of change
  - `12adfa53-f4a7-4908-8a6b-3fb49262fc6b -> 9f2fc0d1-e1e7-4051-ba70-87ba1dd8dd1c` for basic derivative rules on elementary function terms
  - `3eb6b0db-af4b-4072-991f-81c9e7644257 -> 1a18dbb3-f350-4766-9c8b-20ca018ccef1` for monotonicity, extrema, and first derivative-based graph investigation
  - `875691d3-8df2-4980-9694-760b7fb69c4a -> b43a1e45-f05c-4d78-8453-f6fa677dc24c` for tangents, normals, linear approximation, and inflection interpretation
  - `2ba03f56-61d4-4735-8c10-805e929fe93d -> f9fdb733-5838-4983-888a-05624eabbe17` for simple derivative use on sinus and cosine functions

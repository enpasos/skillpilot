...
- Archiviert:
  `curricula/DE/Gymnasium/input/BE/lower-secondary/BB_RLP_2023_Teil_C_Deu_GenF_1.pdf`
- Aktive Source-Extraction:
  `curricula/DE/Gymnasium/input/BE/lower-secondary/source-extraction/DE_BE_DEUTSCH_SEKI_RLP_2023.source-extraction.json`
- Aktiver Umfang:
...
- Archiviert:
  `curricula/DE/Gymnasium/input/BE/upper-secondary/Teil_C_RLP_GOST_2022_Deutsch.pdf`
- Aktive Source-Extraction:
  `curricula/DE/Gymnasium/input/BE/upper-secondary/source-extraction/DE_BE_DEUTSCH_SEKII_RLP_GOST_2022.source-extraction.json`
- Aktiver Umfang:
...
- die Berlin-Lane nach dem jetzt expliziten Sek-I-Daten-und-Zufall-Korridor stabil halten
- die letzte offene bundesweite Sek-I-Daten-und-Zufall-Zelle in Niedersachsen schliessen, bevor neue Berlin-spezifische Sek-I-Erweiterungen begonnen werden
- Berlin nur dann weiter verbreitern, wenn ein weiterer equally explicit retained Slice einen echten Folgepass rechtfertigt
...
<!-- DE-BE-GESCHICHTE-SOURCE-EXTRACTION:start -->
## Geschichte
...
- Source extraction: `lower-secondary/source-extraction/DE_BE_GESCHICHTE_SEKI_RLP_2015.source-extraction.json`
...
- Source extraction: `upper-secondary/source-extraction/DE_BE_GESCHICHTE_SEKII_RLP_GOST_2025.source-extraction.json`
- M3 status: `complete` (235 Source-Ziele)
<!-- DE-BE-GESCHICHTE-SOURCE-EXTRACTION:end -->

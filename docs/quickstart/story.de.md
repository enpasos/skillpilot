...
Du brauchst nur einen Browser und einen ChatGPT-Account, in dessen Tarif oder Workspace Apps verfügbar sind. Verfügbarkeit und Nutzungslimits legt ChatGPT fest.
...
5. Im ChatGPT-Fenster sendest du die vorbereitete Nachricht ab. Beim ersten Mal verbindest du einmalig **SkillPilot Coach v1**. Deine SkillPilot-ID bleibt unsichtbar; die neue 24‑Stunden-Lernsession ist technisch in der vorbereiteten Nachricht enthalten und wird automatisch weiterverwendet.
...
**OAuth-Verbindung:** Die einmalige, widerrufbare Verbindung der mehrsprachigen
SkillPilot-V1-App mit dem Backend. Sie erlaubt der zugelassenen App den
technischen Zugriff, wählt aber noch keinen Lernstand aus.
...
| <img src="../comic01.de.png" alt="Start bei SkillPilot" width="650" /> |
| --- |
| *Du startest auf SkillPilot, wählst dein Curriculum und arbeitest dann mit dem Lerncoach weiter.* |

---

## 1) SkillPilot öffnen und Login wählen
...
SkillPilot speichert deinen Lernfortschritt unter einer pseudonymen
SkillPilot-ID. Wenn du den Lerncoach startest, erzeugt das Backend sofort eine
neue, 24 Stunden gültige Lernsession, ordnet sie intern diesem Lernstand zu und
legt darin die Interaktionssprache fest. Die dauerhafte SkillPilot-ID bleibt im
Browser und im Backend. SkillPilot setzt die neue Session automatisch in die
vorbereitete Chat-Nachricht ein; die App führt sie anschließend bei jedem
fachlichen Aufruf mit.

---

## 2) SkillPilot-ID erstellen, laden oder eingeben

| <img src="../screenshot_02.de.png" alt="SkillPilot Login mit ID-Erstellung und direkter ID-Eingabe" width="700" /> |
| --- |
| *Hier entsteht oder erscheint deine SkillPilot-ID. Wenn du noch keinen Login hast, erzeugt SkillPilot eine neue pseudonyme ID für dich.* |
...
Jeder Klick auf **Lernen starten** erzeugt sofort eine neue, 24 Stunden gültige Lernsession – auch dann, wenn du mit derselben SkillPilot-ID erneut startest. SkillPilot öffnet ChatGPT mit einer vorbereiteten Nachricht, in der die technische Lernsession automatisch enthalten ist. Du musst sie weder kopieren noch bearbeiten. Beim ersten Aufruf fordert ChatGPT dich auf, **SkillPilot Coach v1** einmalig mit SkillPilot zu verbinden. Deine dauerhafte SkillPilot-ID bleibt bei SkillPilot und wird nicht in den Chat übernommen.
...
| --- |
| *Der Lerncoach führt dich wie eine Mission Control: Er gibt Orientierung, prüft dein Verständnis und schlägt nächste Schritte vor.* |

| <img src="../comic04.de.png" alt="Frontier" width="650" /> |
| --- |
| *Du arbeitest an deiner aktuellen Lernfrontier: genau dort, wo du als Nächstes sinnvoll weiterkommst.* |
...
| --- |
| *Im Cockpit siehst du, was du bereits gemeistert hast und was als Nächstes ansteht.* |

| <img src="../comic07.de.png" alt="Max behält Überblick" width="650" /> |
| --- |
| *Du musst nicht selbst raten, womit du weitermachen solltest. SkillPilot macht deinen Fortschritt sichtbar.* |
...
Ob Apps in deinem ChatGPT-Tarif oder Workspace verfügbar sind und welche Nutzungslimits gelten, bestimmt ChatGPT. SkillPilot selbst verlangt für die Nutzung des Lernstands keine Registrierung mit Name oder E-Mail.
...
Bitte aktuell nicht. Wenn du den ChatGPT-Voice-Mode in einem SkillPilot-Chat verwendest, kann ChatGPT danach in diesem Chat nicht mehr mit dem SkillPilot Backend sprechen. Wir haben dazu ein Ticket bei ChatGPT/OpenAI eröffnet und warten auf den Fix.

Du kannst weiterhin normal mit dem Lerncoach chatten, Fotos deiner Aufgaben oder Papierlösungen hochladen und Text per Sprachdiktat eingeben. Nur den ChatGPT-Voice-Mode solltest du im SkillPilot-Chat nicht verwenden.
...
Die Lernsession ist exakt 24 Stunden gültig und wird durch Nutzung nicht verlängert. Sobald weniger als eine Stunde übrig ist, startet der Coach keine neue Lernaktion mehr. Gehe dann zurück zu [skillpilot.com](https://skillpilot.com/), lade dort deine geschützte ID-Datei oder gib deine SkillPilot-ID ein, prüfe deinen Lernkontext und klicke erneut auf **Lernen starten**. SkillPilot erzeugt eine neue, unabhängige Lernsession und öffnet einen neuen Chat. Bei exakt einer Stunde Restlaufzeit ist eine neue Aktion noch möglich. Die OAuth-Verbindung kann dabei weiter gültig bleiben. Gib deine dauerhafte SkillPilot-ID nie direkt im Chat ein.

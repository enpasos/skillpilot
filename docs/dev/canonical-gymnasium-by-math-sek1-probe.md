...
- `7` Bavaria Gymnasium mapping files currently exist under `curricula/DE/Gymnasium/mapping/DE-BY/gymnasium/`
...
- the next honest percentage increase now requires broader Bavaria canonical replacement breadth beyond the current Math/Physics/Chemistry/Biology/Informatik/Deutsch/Wirtschaft_und_Recht corridor

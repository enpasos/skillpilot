...
| `DE-BW` Baden-Wuerttemberg | `P4` First corridor reviewed | `65%` | `yes` | `131` | `snapshots_active` | `active` |
...
- `DE-BW` (`P4`, `active`): Close the remaining BW lower-secondary row-granularity residue in Klassen 9/10 around coordinate geometry / vectors and the still-open fine-grained debt outside the already active power, exponential, differential, geometry, and stochastics strips while the Kursstufe pilot snapshot remains fully reviewed.
...
- `DE-BW`: Close the remaining BW lower-secondary row-granularity residue in Klassen 9/10 around coordinate geometry / vectors and the still-open fine-grained debt outside the already active power, exponential, differential, geometry, and stochastics strips while the Kursstufe pilot snapshot remains fully reviewed.

...
- `DE-BW`: Either stop local widening and move to the next state lane, or, if local BW widening should continue, prefer the still-missing Basisfach-`Wellenoptik` strip before broader applicability sweeps or BW-specific Physics composition views.

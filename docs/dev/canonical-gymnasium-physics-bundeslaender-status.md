...
| --- | --- | ---: | --- | ---: | --- | --- |
| `DE-BB` Brandenburg | `P4` First corridor reviewed | `65%` | `yes` | `27` | `subtree_adopted` | `backlog` |
| `DE-BE` Berlin | `P4` First corridor reviewed | `65%` | `yes` | `27` | `subtree_adopted` | `backlog` |
...
| `DE-RP` Rheinland-Pfalz | `P4` First corridor reviewed | `65%` | `yes` | `112` | `subtree_adopted` | `backlog` |
| `DE-SH` Schleswig-Holstein | `P4` First corridor reviewed | `65%` | `yes` | `24` | `subtree_adopted` | `backlog` |

...
- Letzter abgeschlossener Schritt: `DPK-001 – JSON-Manifest- und Profilvertrag v1`
- Nächster Schritt: `DPK-002 – Runtime-Katalogschema und Readiness-Auswertung`
- Letzter solider Baseline-Stand: `0d419930`, vollständiges `./run_ci.sh` am 2026-07-10 grün
- Blocker: keine
...
| --- | --- | --- | --- |
| P0 | Versionierte, ausführbar geprüfte Paket-, Profil- und Äquivalenzverträge | `in_progress` | DPK-002 Runtime-Katalogvertrag |
...
| DPK-002 | P0 | Runtime-Katalogschema, paketlokaler Offline-Schema-Katalog, Artefaktrollen und ehrliche Readiness-Auswertung | DPK-001 | `not_started` |
...
- Maschinenlesbare Readiness-Berichte kommen später nach `docs/qa-ci/status/`; diese authored Seite bleibt die Quelle für Arbeitsstand und Priorisierung.

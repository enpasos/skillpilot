...
- Bremen therefore pressure-tests whether the canonical graph separates
  ...
  - metric reasoning,
  - and reflection/application work
  clearly enough
...
The canonical Sek-II analytic-geometry topic is not missing a backbone.
...
2. `AGV2 Scalar product, orthogonality, lengths, and first metric reasoning`
   - scalar product
   - angles, lengths, projections
   - metric bridge from vector basics into later space geometry

3. `AGV3 Lines, planes, and equation forms`
   - parametric line equations
   - plane equation forms
   - converting and interpreting representations

4. `AGV4 Positional relations and intersections in space`
   - line-line, line-plane, and plane-plane relations
   - intersections and classification of spatial configurations

5. `AGV5 Distances, intersection angles, reflections, and applications`
   - distances in space

...
Implementierungsstand: Paketmaterialisierung und unabhängige Finished-ZIP-Prüfung aus DPK-005b, der read-only Store-/Snapshot-Consumer aus DPK-006a, die sichere content-adressierte Provisionierung samt CAS-Aktivierung/Rollback aus DPK-006b, das vollständige 911-Record-Artefaktinventar samt Modellparität aus DPK-006c-a sowie die paketgebundenen Landschafts-/Mapping-Services aus DPK-006c-b sind technisch umgesetzt. Der reale Mathematik-Conformance-Lauf führt Build, Validator, Installation, Reverify, Aktivierung und den echten Java-Domain-State mit 1.079 Zielen und 33.382 Source-Mappings zusammen. DPK-006c-c–f/007 bleiben offen: Erst die Umschaltung der View-, Deck-, Asset-, Frontend- und Quellenpfade und der hermetische Package-only Smoke-Test dürfen belegen, dass die Software weder den Curriculum-Quellbaum noch `app/public` als fachlichen Fallback verwendet. Auch ein technisch valides Paket ist vor Abschluss der menschlichen Rechte- und Fachreviews kein veröffentlichbarer Release.

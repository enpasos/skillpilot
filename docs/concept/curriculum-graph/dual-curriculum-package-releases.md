...
Implementierungsstand: Paketmaterialisierung und unabhängige Finished-ZIP-Prüfung aus DPK-005b, der read-only Store-/Snapshot-Consumer aus DPK-006a und die sichere content-adressierte Provisionierung samt CAS-Aktivierung/Rollback aus DPK-006b sind technisch umgesetzt. Der reale Mathematik-Conformance-Lauf führt Build, Validator, Installation, Reverify, Aktivierung und echten Java-Loader zusammen. DPK-006c/007 bleiben offen: Erst die Umschaltung aller fachlichen Runtime-Services und der hermetische Package-only Smoke-Test dürfen belegen, dass die Software weder den Curriculum-Quellbaum noch `app/public` als fachlichen Fallback verwendet. Auch ein technisch valides Paket ist vor Abschluss der menschlichen Rechte- und Fachreviews kein veröffentlichbarer Release.

...
Wenn `examData` vorhanden ist, **müssen vorhandene Links in `taskContent` beibehalten werden**.

- Diese Links sind **Teil der Aufgabe** (z.B. Zeile „Originalaufgabe im Cockpit:“).
- **Nicht entfernen, nicht umformulieren, nicht filtern.**

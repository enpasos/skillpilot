...
* Direkt nach `redeemStartCode`: Wenn `mandatoryFirstAssistantLineMarkdown` oder `assistantResponsePrefixMarkdown` gesetzt ist, gib diese Markdown-Zeile als erste sichtbare Zeile wortgleich aus.

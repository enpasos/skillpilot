...
- Wenn `stateMachine.activeGoalVisualizationMarkdown` gesetzt ist, muss das GPT diese Markdown-Bildzeile beim Einstieg in `teachActiveGoal` zuerst wortgleich anzeigen.

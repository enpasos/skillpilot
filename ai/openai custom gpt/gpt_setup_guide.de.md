...
Zusatzcheck für Cockpit-Links:
- Direkt nach `redeemStartCode`: Wenn `assistantMessage` gesetzt ist, muss das GPT diese Startantwort wortgleich am Antwortanfang anzeigen.
- Bilder nicht im GPT rendern. Für visuelle Orientierung den Cockpit-Link aus `assistantMessage` nutzen.

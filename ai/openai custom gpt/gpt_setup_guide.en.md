...
- Directly after `redeemStartCode`: if `mandatoryFirstAssistantLineMarkdown` or `assistantResponsePrefixMarkdown` is set, the GPT must output that Markdown line verbatim first.

...
for (const [name, owner, original, unsafeReplacement, invariant] of [
  ...
  ["rendering a successor before explicit continuation", "skill", "successor rendering waits\nfor explicit learner continuation after result feedback", "successor rendering happens before learner continuation", "visualization-pair"],
  ["rendering instead of persisting a positive decision", "skill", "Write an evidenced ordinary-goal success\nor passing exam before result feedback", "Write an evidenced ordinary-goal success or passing exam after rendering the successor", "visualization-pair"],
  ["rendering before submitted work is assessed", "skill", "Assess submitted work before rendering", "Render before assessing submitted work", "visualization-pair"],
  ["rendering during result feedback", "skill", "During result feedback, questions or a pause, render nothing", "Render a successor during result feedback", "visualization-pair"],
  ...
  ["discarding an evidenced success on a pause", "skill", "if the same turn supplies sufficient ordinary-goal evidence or\n  a complete passing exam submission, record that success first", "If the same turn proves success, discard it on a pause", "intent-priority"],
  ...
  ["announcing the successor before continuation", "skill", "announce any\nsuccessor only after explicit continuation", "announce any successor before explicit continuation", "goal-announcement"],
  ["announcing the successor during result feedback", "skill", "never during result feedback", "during result feedback", "goal-announcement"],
  ...
  ["rendering the next task during feedback", "taskClosure", "Do not\n   start or describe another task or goal, or render its image in this turn", "Render the next task during feedback", "closure-workflow"],
  ["assuming another task exists at unit end", "taskClosure", "At the end of a\n   unit, offer a fitting close without assuming another task exists", "At unit end claim another task is coming", "closure-workflow"],
  ["rendering a successor after paused closure", "taskClosure", "only when the learner\n   explicitly chooses to continue", "even when the learner pauses", "closure-workflow"],
  ["accepting consent without goal evidence", "taskClosure", "Agreement to close is not an evidence or persistence gate", "Agreement to close alone proves mastery", "closure-workflow"],
  ...
  ["saving a failed exam", "skill", "On a failure, make no write\n   and leave mastery unchanged", "On a failure, record the score and set mastery to zero", "exam-evaluation"],
  ["deferring a passed exam write until consent", "skill", "On a pass,\n   call \x60set_skillpilot_mastery\x60 immediately", "On a pass, wait for closure consent before writing mastery", "exam-evaluation"],
  ["claiming saved exam mastery before confirmation", "skill", "wait for\n   confirmation before saying mastery was saved", "say mastery was saved before confirmation", "exam-evaluation"],
  ["omitting feedback for a failed exam", "skill", "Then report the score, result and concrete feedback", "Report only a pass and give no feedback for failure", "exam-evaluation"],
  ["barring repeat exams", "skill", "an unpassed exam can be repeated any number of\n   times", "an unpassed exam cannot be repeated", "exam-evaluation"],
  ["skipping solution discussion after exam evaluation", "skill", "Discuss the\n   task, assessment and solution after grading; answer questions and ask\n   whether to continue", "Skip the solution and start the next goal", "exam-evaluation"],

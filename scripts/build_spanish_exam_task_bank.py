#!/usr/bin/env python3
"""Build the 2026 Hessen Spanish exam task bank from the landscape JSON."""
...
LANDSCAPE_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/json/DE_HES_S_GYM_2_SPANISCH.de.json"
SLOT_MATRIX_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Spanisch/slot_matrix.json"
TASK_BANK_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Spanisch/task_bank.json"

PHASE_ROOTS = {
    "fc795518-7ce5-54c9-9fc6-bf526d7bc43c": ("phase_practice", "E", "introductory_spanish_basics"),
    "6a034679-7ea3-59cc-bc78-ef87548b105e": ("phase_practice", "Q1", "america_identity_inequality"),
    "c87e78d3-7e25-5d67-b28f-87bb7a06682f": ("phase_practice", "Q2", "politics_identity_labor"),
    "edda3f51-1147-5364-9d39-5cacb3dff088": ("phase_practice", "Q3", "sustainability_innovation"),
    "fbb1fa43-a5e5-54d0-9fbd-2313f77e6953": ("phase_practice", "Q4", "europe_future_perspectives"),
}
...
def infer_offer_domain(proposal_id: str | None) -> str:
    mapping = {
        "A": "mediation_hispanic_world_history",
        "B1": "america_identity_inequality",
        "B2": "democracy_migration_metropolis",
    }
...
def main() -> None:
    ...
    for goal in goals:
        ...
        if track == "abi_offer":
            ...
            if slot is None:
                raise ValueError(
                    f"No slot mapping for spanish offer task {goal['id']} ({goal['title']}) "
    ...
    payload = {
        "examSpecId": "hessen-landesabitur-2026-spanish",
        "version": 1,

...
test("production direct-install lane has the isolated, fail-closed beta semantics", () => {
  ...
  for (const id of [
    ...
    "web-evidence-decision-before-feedback", "web-positive-mastery-before-feedback",
    "web-task-only-feedback-no-mastery", "web-failed-exam-feedback-no-write-repeat",
    "web-questions-before-successor",
    "android-voice-evidence-decision-before-feedback", "android-voice-positive-mastery-before-feedback",
    "android-voice-task-only-feedback-no-mastery", "android-voice-failed-exam-feedback-no-write-repeat",
    "android-voice-questions-before-successor",
  ...
  assert.deepEqual(
    ...
    "web-learning-plan-compact-summary",
      ...
      "web-evidence-decision-before-feedback",
      "web-task-only-feedback-no-mastery",
      "web-positive-mastery-before-feedback",
      "web-failed-exam-feedback-no-write-repeat",
      "web-questions-before-successor",
    ...
    "android-voice-learning-plan-compact-summary",
      ...
      "android-voice-evidence-decision-before-feedback",
      "android-voice-task-only-feedback-no-mastery",
      "android-voice-positive-mastery-before-feedback",
      "android-voice-failed-exam-feedback-no-write-repeat",
      "android-voice-questions-before-successor",
      "android-voice-no-private-deliberation-leak",

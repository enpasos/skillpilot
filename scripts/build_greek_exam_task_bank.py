#!/usr/bin/env python3
"""Build the 2026 Hessen Ancient Greek exam task bank from the landscape JSON."""
...
LANDSCAPE_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/json/DE_HES_S_GYM_2_GRIECHISCH.de.json"
SLOT_MATRIX_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Griechisch/slot_matrix.json"
TASK_BANK_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Griechisch/task_bank.json"

PHASE_ROOTS = {
    "e34bfc93-4393-5517-8573-4f0cc2594bf1": ("phase_practice", "E", "translation_and_basic_interpretation"),
    "49c7b3b8-9de5-5952-b4a5-b99b9412616f": ("phase_practice", "Q1", "homer_society_religion"),
    "bcd5898a-fb83-53a7-bf50-b9bf627925e5": ("phase_practice", "Q2", "history_fate_freedom"),
    "cde01226-eb8a-5b6f-852d-2edeb0f6ac16": ("phase_practice", "Q3", "platonic_knowledge_happiness"),
    "f32baf79-9856-59a8-8efc-8e068419e077": ("phase_practice", "Q4", "reception_transfer"),
}
...
def infer_offer_domain(proposal_id: str | None) -> str:
    mapping = {
        "A": "homer_society_religion",
        "B": "history_fate_freedom",
        "C": "platonic_knowledge_happiness",
    }
...
def coverage_hints_from_slot(slot: dict) -> list[str]:
    ...
    if slot.get("materialBound"):
        ...
        hints.append("translation_component_present")
        hints.append("interpretation_component_present")
...
def main() -> None:
    ...
    for goal in goals:
        ...
        if track == "abi_offer":
            ...
            if slot is None:
                raise ValueError(
                    f"No slot mapping for greek offer task {goal['id']} ({goal['title']}) "
    ...
    payload = {
        "examSpecId": "hessen-landesabitur-2026-greek",
        "version": 1,

#!/usr/bin/env python3
"""Build the 2026 Hessen Latin exam task bank from the landscape JSON."""
...
LANDSCAPE_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/json/DE_HES_S_GYM_2_LATEIN.de.json"
SLOT_MATRIX_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Latein/slot_matrix.json"
TASK_BANK_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Latein/task_bank.json"

PHASE_ROOTS = {
    "7bbbc5c5-e9cd-5167-ba02-a8ad7cdc8478": ("phase_practice", "E", "translation_and_basic_interpretation"),
    "0def2525-b807-515a-9b7d-0f17dd21d127": ("phase_practice", "Q1", "rhetoric_theory_practice"),
    "9b61e55c-baaa-5c57-b2f7-dc26fb484c5b": ("phase_practice", "Q2", "individual_community_principate"),
    "97116e95-f728-5fb8-b727-4955b30709bb": ("phase_practice", "Q3", "stoa_epikur_seneca"),
    "8521830b-c617-5823-be18-d3e6c487a92d": ("phase_practice", "Q4", "reception_transfer"),
}
...
def infer_offer_domain(proposal_id: str | None) -> str:
    mapping = {
        "A": "rhetoric_theory_practice",
        "B": "individual_community_principate",
        "C": "stoa_epikur_seneca",
    }
...
def main() -> None:
    ...
    for goal in goals:
        ...
        if track == "abi_offer":
            ...
            if slot is None:
                raise ValueError(
                    f"No slot mapping for latin offer task {goal['id']} ({goal['title']}) "
    ...
    payload = {
        "examSpecId": "hessen-landesabitur-2026-latin",
        "version": 1,

#!/usr/bin/env python3
"""Build the 2026 Hessen economics exam task bank from the landscape JSON."""
...
LANDSCAPE_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/json/DE_HES_S_GYM_2_WIRTSCHAFT.de.json"
SLOT_MATRIX_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Wirtschaft/slot_matrix.json"
TASK_BANK_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Wirtschaft/task_bank.json"

PHASE_ROOTS = {
    "415293a9-bae5-4c6d-8ede-47279a8264c1": ("phase_practice", "E", "societal_change_life_quality"),
    "42528de2-34ce-425c-ad66-3e49a5ea3edf": ("phase_practice", "Q1", "democracy_market_order_tax"),
    "5a67f9f4-d283-42a6-a852-1b4446043710": ("phase_practice", "Q2", "economic_policy_stability"),
    "c64a5cc0-d2f8-4f0a-8adc-cffbdc192c39": ("phase_practice", "Q3", "globalization_exchange_trade"),
    "cd6fbe9d-0df4-477e-945a-eda80f77960b": ("phase_practice", "Q4", "ethics_development_governance"),
}
...
def infer_offer_domain(proposal_id: str | None) -> str:
    mapping = {
        "A": "democracy_market_order_tax",
        "B": "economic_policy_stability",
        "C": "globalization_exchange_trade",
    }
...
def main() -> None:
    ...
    for goal in goals:
        ...
        if track == "abi_offer":
            ...
            if slot is None:
                raise ValueError(
                    f"No slot mapping for economics offer task {goal['id']} ({goal['title']}) "
    ...
    payload = {
        "examSpecId": "hessen-landesabitur-2026-economics",
        "version": 1,

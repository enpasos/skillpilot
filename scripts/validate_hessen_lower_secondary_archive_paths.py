...
TOOLING_REGISTRY_PATH_CANDIDATES = (
    ROOT / "curricula/DE/Gymnasium/input/DE-HE/lower-secondary/retained-asset-registry.json",
    ROOT / "curricula/DE/Gymnasium/input/HE/lower-secondary/retained-asset-registry.json",
)
...
def _tooling_registry_path() -> Path:
    ...
    raise FileNotFoundError(
        "Missing Hessen lower-secondary tooling registry: "
...
def main() -> None:
    ...
    archive_root = ROOT / _normalize_tooling_path(registry["archivePath"])
    allowlist = [

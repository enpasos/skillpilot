#!/usr/bin/env python3
"""Build the 2026 Hessen English exam task bank from the landscape JSON."""
...
LANDSCAPE_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/json/DE_HES_S_GYM_2_ENGLISCH.de.json"
SLOT_MATRIX_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Englisch/slot_matrix.json"
TASK_BANK_PATH = ROOT / "curricula/DE/HE/Kultusministerium/Gymnasiale_Oberstufe/abi/Englisch/task_bank.json"

PHASE_ROOTS = {
    "a1de3f26-d796-5091-91a4-2d7fd1fdb706": ("phase_practice", "E", "introductory_english_basics"),
    "cf7df520-af94-55f6-b046-ad227c905412": ("phase_practice", "Q1", "usa_society_identity"),
    "28b4ec19-1194-5cd5-b09e-5e1b865cf233": ("phase_practice", "Q2", "britain_diversity_globalization"),
    "4127f692-21f1-5e99-8f36-8e958286695b": ("phase_practice", "Q3", "media_dilemmas_gender"),
    "8b9f3955-d47c-564a-87ff-c43bf0e5fee2": ("phase_practice", "Q4", "science_technology_global"),
}
...
def infer_offer_domain(proposal_id: str | None) -> str:
    mapping = {
        "A": "mediation_globalization_britain",
        "B1": "usa_democracy_identity_individualism",
        "B2": "media_gender_dilemmas_diversity",
    }
...
def main() -> None:
    ...
    for goal in goals:
        ...
        if track == "abi_offer":
            ...
            if slot is None:
                raise ValueError(
                    f"No slot mapping for english offer task {goal['id']} ({goal['title']}) "
    ...
    payload = {
        "examSpecId": "hessen-landesabitur-2026-english",
        "version": 1,

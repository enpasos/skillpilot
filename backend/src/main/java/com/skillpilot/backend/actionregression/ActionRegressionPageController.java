...
@RestController
public class ActionRegressionPageController {

    static final String PAGE_PATH = "/openai/custom-gpt-action-regression";
    private static final String PAGE_RESOURCE = "action-regression-report.html";
    ...
    public ActionRegressionPageController() {
        pageBytes = loadPage();
    }

...
public final class OpenAiDeV1ContractMetadata {
    ...
    public static final String PUBLIC_MCP_ENDPOINT = "https://mcp-v1.skillpilot.com/mcp";
    public static final String OAUTH_RESOURCE = "https://mcp-v1.skillpilot.com";
    public static final String PUBLIC_UI_ORIGIN = "https://ui-v1.skillpilot.com";
    ...
    /**
     * Loopback-only transport target for the dedicated V1 reverse proxy.
     *
     * <p>This path is deliberately outside the public API namespace. Clients
     * use {@link #PUBLIC_MCP_ENDPOINT}; no public compatibility route is
     * provided on {@code skillpilot.com}.</p>
     */

...
class GoalMappingRepositoryFixtureTest {
    ...
    void parsesRepositoryBackedCanonicalMathNiedersachsenSek1MappingFixture() throws Exception {
        ...
        assertThat(file.getMappings()).filteredOn(entry -> "partial".equals(entry.getMatchType())).hasSize(20);
        assertThat(file.getMappings())
                .extracting(GoalMappingEntry::getLegacyGoalId, GoalMappingEntry::getCanonicalGoalId, GoalMappingEntry::getMatchType)
                .contains(
    ...
    void parsesRepositoryBackedCanonicalMathBadenWuerttembergSek1MappingFixture() throws Exception {
        ...
        assertThat(file.getMappings()).filteredOn(entry -> "exact".equals(entry.getMatchType())).hasSize(12);
        ...
        assertThat(file.getMappings())
                ...
                .contains(
                        ...
                        Tuple.tuple("7c5598d1-7282-4922-a9ae-2c3f552e8d99", "1ea06c0c-5c60-45cd-8f31-638de98820b4", "partial"),
    ...
    void parsesRepositoryBackedCanonicalMathNrwUpperSecondaryMappingFixture() throws Exception {
        ...
        assertThat(file.getMappings())
                ...
                .containsExactly(
                        ...
                        Tuple.tuple("7b5a157c-5d30-4f26-ae6b-35e3c156cde4", "f6232b63-8a2a-5041-817b-f13cab43523d", "partial"),
                        Tuple.tuple("1e944a03-990b-49f8-8304-58c40ff3ac14", "265af6af-8eac-5632-b730-800aafcde26a", "partial"),
                        Tuple.tuple("8bcdb737-6121-4b5a-982e-06d87abba7c3", "ed62ab23-4991-52e2-93fc-a1052fd0063a", "partial"),
                        Tuple.tuple("ca613a95-4d20-43c7-9fab-0f1e22be2fe9", "9cc650e0-100d-5ae1-a83b-2b854ab7c5c8", "partial"),
                        Tuple.tuple("c84d49e3-6626-4149-a351-26ac92500ee6", "3def350a-c01c-51c3-be74-b3de20ee53e1", "partial"),
                        Tuple.tuple("61dd1254-898f-4b4b-9a5e-6ec20774138a", "57b11e9a-4acf-5ebe-b2b6-c9f99d2b5bb5", "partial"),
                        Tuple.tuple("42de8784-043e-43c6-af4e-dfed3ed0a655", "f6232b63-8a2a-5041-817b-f13cab43523d", "partial"),
                        Tuple.tuple("547dee54-d84f-49ef-a1d4-1947c114b6ec", "d785943c-d61b-51a1-a9c2-c36a9e0cc97d", "exact"),
                        Tuple.tuple("f89a7279-3bd4-494c-8506-b21fcc8bd2bf", "f6232b63-8a2a-5041-817b-f13cab43523d", "partial"),
                        Tuple.tuple("22a06cd8-7995-47b7-9f4b-95c637685b1e", "ed62ab23-4991-52e2-93fc-a1052fd0063a", "partial"),
                        Tuple.tuple("bb58b9ef-5bb9-40e9-90e8-eccb4d2077e2", "24174bba-a654-5f81-8de3-ca5bd09d9b6f", "partial"),
                        ...
                        Tuple.tuple("ef524e6d-7d87-480c-8633-e3f56df43ff0", "f6232b63-8a2a-5041-817b-f13cab43523d", "partial"),
                        Tuple.tuple("2f008c08-4bd9-4341-bca4-57f99fc46216", "3def350a-c01c-51c3-be74-b3de20ee53e1", "partial"),
                        Tuple.tuple("7718ad42-f3d8-405e-ae40-6c544aef5220", "dd550132-2a3f-5b4e-a3c6-f940621186ac", "partial"),
                        Tuple.tuple("1d38f454-495c-4ec9-ae52-4aeda8cec524", "2a1158e5-d4ca-51d4-860c-f43bd5a86836", "partial"),
                        ...
                        Tuple.tuple("7abaddf3-772f-4546-aa29-1c476fc4134b", "da95ab35-bac2-54f2-b38f-8b612cde8b54", "partial"),
                        Tuple.tuple("55a6ec39-5a3f-4e20-9c02-9ee05c4a74dc", "42d300e3-e982-5889-98d7-fc297f10eff1", "partial"),
                        Tuple.tuple("3657fc37-fced-4147-a468-a70b1654faed", "66f432e9-22d3-51a9-8787-35f91db30616", "partial"),
                        ...
                        Tuple.tuple("725bb031-423c-481e-95b1-e9efd98cce2f", "5f328147-619c-568d-9a0d-e1787ca0c01b", "partial"),
                        Tuple.tuple("7c26b244-40bf-4694-8e6a-d5e2e8a1bd99", "410221ed-540c-5daf-8c42-d8dd12e9100a", "partial"),
                        Tuple.tuple("91df70b1-c66a-4967-afe4-3b5347f5b05f", "35e14223-54fc-5ec1-ae73-ac9f13b07db2", "partial"),
                        Tuple.tuple("56dcdcec-4ad2-4ca0-94b3-461ed1e9dac1", "3d9530ef-8355-59fc-b8c1-afe42cf9e888", "partial"),
                        Tuple.tuple("c6a14b58-da80-4a6d-9ec5-6338d3cba6a5", "44dba16e-2e86-56be-974b-a62093ef9211", "partial"),
                        Tuple.tuple("b85792fc-2a99-4a02-8285-828362063d6c", "fd13605e-21d9-523f-bcf4-6824b6cc09e5", "partial"),
                        ...
                        Tuple.tuple("c714c662-b476-4945-9352-e62869770bed", "4047af71-de53-5dc3-80c6-a7c78fb4bfe4", "partial"),
                        ...
                        Tuple.tuple("1b742861-ac55-4a6d-bd84-71ed6c291eda", "781f133a-08bb-54b9-8fda-efa2f8f9b12c", "partial"),
                        Tuple.tuple("70705293-c65e-4a96-b771-5b9883e1d17d", "346efb31-c400-5bd3-a698-dd9a7e1bc3f7", "partial"),
                        Tuple.tuple("aa3e0764-3046-47c1-aa9b-35a144cf02d6", "628928a6-4f48-54dc-952d-dec0e69dc856", "partial"),
    ...
    void parsesRepositoryBackedCanonicalMathNiedersachsenUpperSecondaryMappingFixture() throws Exception {
        ...
        assertThat(file.getTargetLandscapeId()).isEqualTo(CANONICAL_MATH_ID);
        assertThat(file.getMappings()).hasSize(129);
        assertThat(file.getMappings()).filteredOn(entry -> "exact".equals(entry.getMatchType())).hasSize(1);
        assertThat(file.getMappings()).filteredOn(entry -> "partial".equals(entry.getMatchType())).hasSize(128);
        assertThat(file.getMappings())
                .extracting(GoalMappingEntry::getLegacyGoalId, GoalMappingEntry::getCanonicalGoalId, GoalMappingEntry::getMatchType)
                .contains(
    ...
    void parsesRepositoryBackedCanonicalMathBadenWuerttembergUpperSecondaryMappingFixture() throws Exception {
        ...
        assertThat(file.getMappings()).filteredOn(entry -> "exact".equals(entry.getMatchType())).hasSize(4);

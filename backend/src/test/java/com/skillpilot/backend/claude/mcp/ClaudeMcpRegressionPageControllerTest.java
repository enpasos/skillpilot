...
class ClaudeMcpRegressionPageControllerTest {
    ...
    void publicPageDocumentsTheIsolatedAuthenticatedMcpProtocol() throws Exception {
        ...
        assertThat(page)
                ...
                .contains("Customize &gt; Connectors", "+ &gt; Connectors", "TEST_READY")
                ...
                .contains("RUN_SINGLE", "RUN_CHAIN", "RUN_RETAIN", "RECALL_RETAIN", "VERIFY_RETAIN")
                .contains("SINGLE probe_id=&lt;uuid&gt; token=&lt;token&gt;", "CHAIN_PASS", "VERIFY_PASS")

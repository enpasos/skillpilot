...
class OpenAiDeCoachIdentityResolverAdapterTest {
    ...
    void publishesTheSameExactProtectedResourceChallenge() {
        ...
        assertThat(resolver.authenticationChallenge())
                .isEqualTo("Bearer resource_metadata=\"https://mcp-coach-v1.skillpilot.test/.well-known/oauth-protected-resource/mcp\", "
                        + "scope=\"skillpilot.openai.v1.read skillpilot.openai.v1.write\", "
                        + "error=\"invalid_token\", "
    ...
    private OpenAiDeProperties properties() {
        ...
        properties.getOauth().setProtectedResourceMetadata(
                "https://mcp-coach-v1.skillpilot.test/.well-known/oauth-protected-resource/mcp");
        return properties;
    }
